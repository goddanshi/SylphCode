...
$this->title = 'Поддержка сайтов — SylphCode';
?>

<div class="container-xxl custom-container text-white py-5" style="min-height: 80vh;">
  <h1 class="mb-4" style="font-weight: 800; font-size: 3rem;">Поддержка сайтов</h1>
  <p class="lead mb-5" style="font-size: 1.25rem; max-width: 720px;">
      Обеспечьте стабильную работу вашего сайта с нашей профессиональной поддержкой. Мы следим за обновлениями, безопасностью и оперативно решаем любые проблемы.
  </p>

  <h2 class="mb-3" style="font-weight: 700;">Наши услуги</h2>
  <ul class="list-unstyled mb-5" style="max-width: 720px;">
    <li class="mb-2">
      <i class="fas fa-check-circle me-2 text-primary"></i>Обновление CMS и плагинов
    </li>
    <li class="mb-2">
      <i class="fas fa-check-circle me-2 text-primary"></i>Мониторинг работоспособности
    </li>
    <li class="mb-2">
      <i class="fas fa-check-circle me-2 text-primary"></i>Регулярное резервное копирование
    </li>
    <li class="mb-2">
      <i class="fas fa-check-circle me-2 text-primary"></i>Защита от взломов и вирусов
    </li>
    <li class="mb-2">
      <i class="fas fa-check-circle me-2 text-primary"></i>Техническая консультация
    </li>
  </ul>
  ...
  <div class="d-block d-md-none service-cards text-white" style="max-width: 720px;">
    <div class="service-card mb-3 p-3 rounded">
      <div class="fw-bold text-primary">Базовая поддержка</div>
      <div class="mt-2 text-end fw-semibold">от 5 000 ₽</div>
    </div>

    <div class="service-card mb-3 p-3 rounded">
      <div class="fw-bold text-primary">Расширенная поддержка</div>
      <div class="mt-2 text-end fw-semibold">от 10 000 ₽</div>
    </div>

    <div class="service-card mb-3 p-3 rounded">
      <div class="fw-bold text-primary">Техническая консультация</div>
      <div class="mt-2 text-end fw-semibold">от 1 200 ₽</div>
    </div>
  </div>
